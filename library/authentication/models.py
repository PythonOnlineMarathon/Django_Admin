...
class CustomUserManager(BaseUserManager):
    def create_user1(self, email, password, first_name=None, middle_name=None, last_name=None):
        return CustomUser.create(email=email, password=password, first_name=first_name, middle_name=middle_name, last_name=last_name, role=0)
    def create_superuser1(self, email, password, first_name=None, middle_name=None, last_name=None):
        user = CustomUser.create(email=email, password=password, first_name=first_name, middle_name=middle_name, last_name=last_name, role=0)
    ...
    def create_admin(self, email, password, first_name=None, middle_name=None, last_name=None):
        return CustomUser.create(email=email, password=password, first_name=first_name, middle_name=middle_name, last_name=last_name, role=1)
    def create(self, email, password, first_name=None, middle_name=None, last_name=None, role=0):
        if role==0:
            return self.create_user(email=email, password=password, first_name=first_name, middle_name=middle_name, last_name=last_name, )
        if role==1:
            return self.create_admin(email=email, password=password, first_name=first_name, middle_name=middle_name, last_name=last_name,)
...
class CustomUser(AbstractBaseUser):
    ...
    middle_name = models.CharField(max_length=20, default='None', blank=True)
    email = models.CharField(max_length=100, unique=True, default=None, blank=True)
